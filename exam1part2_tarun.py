# -*- coding: utf-8 -*-
"""Exam1Part2-tarun.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Q7W51h0t_jcz_o9u6u2gk08uZ5pomVzR
...
print(correlation_stroke_price)
...
# Selecting only numeric columns (excluding non-numeric columns)
...
# Write your code below and press Shift+Enter to execute
df_group_body_style = df[['body-style', 'price']].groupby('body-style', as_index=False).mean()
...
# Select only numerical columns (int64 or float64)
numeric_columns = df.select_dtypes(include=['int64', 'float64'])
